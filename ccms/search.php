...
<style type="text/css">
    .right-panel{
        background-image: url(https://sackim.com/wp-content/uploads/2020/01/1.jpg);
                                ...
                                <div class="card-box">
                                       ...
                                       <div class="form-group row">
                                                   ...
                                                   <div class="card-footer" >
                                                       <p style="text-align: center; margin-top: 5px; margin-bottom: 5px; "><button type="submit" class="btn btn-primary btn-sm" name="search" id="submit" style="font-size: 20px;">
