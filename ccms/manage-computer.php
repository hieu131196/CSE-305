...
<head>
    ...
    <link href='https://fonts.googleapis.com/css?family=Open+Sans:400,600,700,800' rel='stylesheet' type='text/css'>
     ...
     <style type="text/css">
    .right-panel{
        background-image: url( https://wallpaperbat.com/img/433324-orange-abstract-wallpaper-top-free-orange-abstract-background.jpg);
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="add-computer.php">Add Computers</a></li>
