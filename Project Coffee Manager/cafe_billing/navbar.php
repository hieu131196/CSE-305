...
<nav id="sidebar" class='mx-lt-5 bg-dark' >
		...
		<div class="sidebar-list">
				<a href="index.php?page=home" class="nav-item nav-home"><span class='icon-field'><i class="fas fa-bell"></i></i>
				</span> Notification</a>

				<a href="http://localhost:8080/ccms/dashboard.php" class="nav-item nav-orders2">
					<span class='fa fa-globe'><i class="fa fa-clipboard-list ">	
					</i></span> Cyber Admin</a>

				<a href="index.php?page=orders" class="nav-item nav-orders">
					<span class='icon-field'>
					<i class="fa fa-clipboard-list "></i></span> Orders</a>
