		...
		<div class="card-body">
			<form action="" id="manage-settings">
				...
				<div class="form-group" >
						...
						<textarea name="about" class="text-jqte" id="page_content" >
							<?php echo isset($meta['about_content']) ? $meta['about_content'] : '' ?></textarea> 
					<!-- 	<?php if(isset($meta["about_content"])) { echo $meta["about_content"]; } ?>
 -->
				</div>
				<div class="form-group">
					<label for="" class="control-label"><b style="font-size: 15px;">Image setting background</b></label>
					<input type="file" class="form-control" style="padding: 0px; line-height:1.9;" name="img" onchange="displayImg(this,$(this))">
				</div>
				<div class="form-group">
